...
Details
	...
	Http API authentication using several schemas based on HMAC signatures in HTTP Authentication header (Startegy design pattern)
...
Authentication schemas:
	...
	mysch  Authorization = mysch HmacAlgorithm,TimeStampUnixEpochUTC,UserId,HMAC-SHA64(RequestURI+TimeStampUnixEpochUTC,UserIdSecret)
